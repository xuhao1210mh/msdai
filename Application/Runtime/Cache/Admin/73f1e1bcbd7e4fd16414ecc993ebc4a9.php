      ...
      <table class="layui-table">
        ...
        <tbody>
            <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a title="审核"  onclick="x_admin_show('查看','checkLoan/?loan_id=<?php echo ($val["loan_id"]); ?>&uid=<?php echo ($val["uid"]); ?>')" href="javascript:;"><?php echo (strtotime($val["put_time"])); ?></a></td>
                <td><?php echo ($val["sum"]); ?></td>
                <td><?php echo ($val["name"]); ?></td>
                <td><?php echo ($val["number"]); ?></td>
                <td><?php echo ($val["put_time"]); ?></td>
                ...
                <td class="td-manage">
                  ...
                  <button class="btn btn-primary btn-sm yes" ><a title="凭证" style="text-decoration:none; color: white;" onclick="x_admin_show('查看','voucherDetails2/?loan_id=<?php echo ($val["loan_id"]); ?>&uid=<?php echo ($val["uid"]); ?>',650,800)">凭证</a></button>
                  <button class="btn btn-info btn-sm yes" ><a title="催收" style="text-decoration:none; color: white;" onclick="x_admin_show('催收','collection/?loan_id=<?php echo ($val["loan_id"]); ?>&uid=<?php echo ($val["uid"]); ?>',650,500)">催收</a></button>
                  <button class="btn btn-danger btn-sm no"><a title="删除" style="text-decoration:none; color: white;" onclick="del(this,'要删除的id')" href="javascript:;">删除</a></button>
                </td>
