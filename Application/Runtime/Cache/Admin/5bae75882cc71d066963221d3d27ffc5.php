        ...
        <tbody>
          <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
              ...
              <td class="td-manage">
                ...
                <!-- <a onclick="x_admin_show('修改密码','userPassword',600,400)" title="修改密码" href="javascript:;">
                  <i class="layui-icon">&#xe631;</i>
                </a> -->
                <a title="删除" onclick="del(this,'<?php echo ($val["uid"]); ?>')" href="javascript:;">
                  <i class="layui-icon">&#xe640;</i>
                </a>
              </td>
    ...
    <script>
      ...
      function del(obj,uid){
          layer.confirm('确认要删除吗？',function(index){
              //发异步删除数据
              $.ajax({
                url: "<?php echo U('/admin/admin/delUser');?>",
                type: "post",
                dataType: "json",
                data: {
                    uid: uid,
