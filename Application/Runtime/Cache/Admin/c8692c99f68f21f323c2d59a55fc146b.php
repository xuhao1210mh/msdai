    ...
    <div class="x-body">
        <form class="layui-form">
          <div class="layui-form-item">
              <p style="display: none" id="id"><?php echo ($receipt_id); ?></p>
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>时间(天)
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="day" name="name" required="" lay-verify="required"
    ...
    <script>
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
            ...
            //发异步，把数据提交给php
            $.ajax({
                url: "<?php echo U('/admin/admin/again');?>",          //展期
                type: "post",
                dataType: "json",
                data: {
                    receipt_id: $('#id').text(),
