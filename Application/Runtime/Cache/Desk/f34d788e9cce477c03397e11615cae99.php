...
<head>
    ...
    <script src="/Public/assets/js/canvas2image.js"></script>
...
<div class="hp_cont">
    <div class="hp">
        ...
        <div class="qz">
            <img src="/Public/setting/<?php echo ($pic); ?>" alt="">
            <span>签字区域</span>
        </div>
    </div>
    <div class="jkg">
...
<div>
    <ul class="rq">
        <li><span>借款日期</span><span><?php echo ($apply_time); ?></span></li>
        <li><span>还款日期</span><span><?php echo ($dead_time); ?></span>
            <!-- <del>原：2018-06-10(已展期)</del> -->
        </li>
        <li><span>借款金额</span><span class="qian"><?php echo ($sum); ?>元</span></li>
        <li><span>年化利率</span><span><?php echo ($rate); ?>%</span></li>
        <li><span>本息共计</span><span class="qian"><?php echo ($repay); ?>元</span></li>
        <li><span>借款用途</span><span><?php echo ($use); ?></span></li>
    </ul>
...
<div class="xybh">
    ...
    <ul class="rq">
        <li><span>协议编号</span><span><?php echo ($time); ?></span>
...
<div class="shpz">
    ...
    <ul class="rq">
        <li><span>实际还款日期</span><span>2018-06-02</span></li>
        <li><span>是否逾期</span><span>否</span></li>
        <li><span>协议编号</span><span>123165465123132346</span>
            <!-- <a href="http://ypz.youmaijinkong.com/m/agreement/iou/2/!Zqv8rN!2rNv8vT86">电子协议(点击查看详情)</a> -->
        </li>
    </ul>
</div>
