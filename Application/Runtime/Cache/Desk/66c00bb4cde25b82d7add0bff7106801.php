...
<div class="data">
    ...
    <div class="address">
        ...
        <div>
            ...
            <input type="text" placeholder="请填写详细地址" style="margin-top: 40px" id="address">
        </div>
        </div>
    <div class="job">
        <div>您的工作岗位:</div>
        <div><input type="text" id="position"></div>
    </div>
    <div class="mony">
        <div>您的收入:</div>
        <div><input type="text" style="width:50%" id="income"> <span>元</span></div>
    </div>
    <div >
        <div>单位电话:</div>
        <div><input type="number" id="number"></div>
    </div>
    <button class="xyb" id="submit"><a>下一步</a></button>
</div>
<script src="/Public/assets/js/vue.js"></script>
<!-- <script src="/Public/assets/city/city.js"></script> -->

<script type="text/javascript">
	$(document).ready(function(){
		addressInit('prov', 'city', 'area');  
    });
</script>
<script src="/Public/assets/city/city.js"></script>
...
<script>
    $('#submit').click(function(){
        ...
        var province = $('#prov').find('option:selected').val();     //省
        var city = $('#city').find('option:selected').val();         //市
        var area = $('#area').find('option:selected').val();         //区/县
        ...
        $.ajax({
            url: "<?php echo U('/desk/certification/writeInfo');?>",
            type: "post",
            dataType: "json",
            data: {
                company: company,
