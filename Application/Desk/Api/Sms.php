...
require_once __DIR__ . '/SmsSdk/vendor/autoload.php';
...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIp3xoquiO415s"; // AccessKeyId

        $accessKeySecret = "odPJn3g6tbxlPGbX5fjkn0SITMEIWT"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($number, $captcha) {
        ...
        $request->setSignName("张崇威");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_139450153");
...
// echo json_encode(SmsDemo::Message);
